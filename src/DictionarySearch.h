...
public:
    ...
    BOOL FindPhraseForPrefix(_Out_ CDictionaryResult **ppdret);
...
private:
    BOOL FindWorker(BOOL isTextSearch, _Out_ CDictionaryResult **ppdret, BOOL isWildcardSearch, BOOL isPrefixSearch);
