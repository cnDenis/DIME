...
{
public:
    CCandidateListUIPresenter(_In_ CDIME *pTextService, ATOM atom,
    ...
    void _SetText(_In_ CDIMEArray<CCandidateListItem> *pCandidateList, BOOL isAddFindKeyCode);
    void _SetKeystrokeCode(_In_ CStringRange *pKeystrokeCode);
    void _ClearList();
    ...
    void _RefreshCandidateContent(_In_opt_ CStringRange *pKeystrokeCode, _In_opt_ CDIMEArray<CCandidateListItem> *pCandidateList);
    void _RefreshInputModeStatus();
    void _PresentCandidateWindow();
    BOOL HasCandidateWindow() const { return _pCandidateWnd != nullptr; }
...
private:
    ...
    void _EnsureCandidateWindowVisible();
    ...
    void AddCandidateToCandidateListUI(_In_ CDIMEArray<CCandidateListItem> *pCandidateList, BOOL isAddFindKeyCode);

    void SetPageIndexWithScrollInfo(_In_ CDIMEArray<CCandidateListItem> *pCandidateList);
    void _SyncInputModeStatus();
    BOOL _ExpandCandidateListIfNeeded();
    BOOL _NeedsExpandBeforePageDown(_In_ int pageOffset) const;
