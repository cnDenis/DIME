...
// Unicode escapes avoid mojibake when source encoding differs from compiler expectations.
static const WCHAR TEXTSERVICE_DESC[] = L"\u8FEA\u94ED\u4e94\u7b14";
...
void UnregisterProfiles()
{
    ...
    hr = pITfInputProcessorProfileMgr->UnregisterProfile(Global::DIMECLSID, TEXTSERVICE_LANGID, Global::DIMEGuidProfile, 0);
    if (FAILED(hr))
    {
        goto Exit;
    }
