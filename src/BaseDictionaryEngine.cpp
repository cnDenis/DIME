...
VOID CBaseDictionaryEngine::SortListItemByFindKeyCode(_Inout_ CDIMEArray<CCandidateListItem> *pItemList)
{
...
VOID CBaseDictionaryEngine::MergeSortByFindKeyCode(_Inout_ CDIMEArray<CCandidateListItem> *pItemList, int leftRange, int rightRange)
{
